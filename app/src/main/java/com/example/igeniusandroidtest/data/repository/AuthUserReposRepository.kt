...
interface AuthUserReposRepository {
    ...
    suspend fun checkStarredRepository(ownerName: String, nameRepository: String): Result<Int>
    suspend fun starRepository(ownerName: String, nameRepository: String):Result<Int>
    suspend fun unstarRepository(ownerName: String, nameRepository: String):Result<Int>
}